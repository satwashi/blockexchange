    ...
    <div className="rounded-lg overflow-hidden border border-border">
      ...
      <div className="bg-card">
        {sortedData.map((crypto, index) => {
          const cleanedSymbol = crypto.symbol.replace("USDT", "").toLowerCase();

          return (
            <div key={crypto.symbol}>
              {/* 🖥️ Desktop Row */}
              <Link
                href={`/trade/${cleanedSymbol}`}
                className="hidden md:grid grid-cols-12 gap-4 px-4 py-4 border-b border-border/50 transition-colors hover:bg-accent hover:text-accent-foreground group"
              >
              ...
              <Link
                href={`/trade/${cleanedSymbol}`}
                className="md:hidden block p-4 border-b border-border/50 transition-colors hover:bg-accent hover:text-accent-foreground"
              >
